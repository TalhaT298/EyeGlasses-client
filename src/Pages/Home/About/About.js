...
const About = () => {
  ...
  <div className="hero-content flex-col lg:flex-row">
    ...
    <div className='w-1/2'>
        <Link to='/aboutUs'><p className='text-2xl font-bold text-yellow-600'>About Us</p></Link>
      ...
      <Link to='shopmore'><button className="btn btn-outline">Get More Info</button></Link>
    </div>
  </div>
</div>
    );
